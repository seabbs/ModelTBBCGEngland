...
params: 
  model: ""
  model_dir: "results/evaluated-scenarios-2019-06-13_09:41:56-calibration-run/transmission_varies_all-2019-06-13_09:41:58"
vignette: >
...
plot_state(model, states = c("YearlyHistPInc", "YearlyInc", 
                             "YearlyChildInc", "YearlyOlderAdultInc"), 
           summarise = FALSE, start_time = 49)
```

- Table fitted states

```{r}
pred_obs <- plot_state(model, states = c("YearlyHistPInc",
                                         "YearlyInc", "YearlyAgeInc"), 
...
plot_state(model, 
           states = c( "YearlyChildInc", "YearlyAdultInc", "YearlyOlderAdultInc"), 
           start_time = 59) + theme(legend.position = "none")
```
