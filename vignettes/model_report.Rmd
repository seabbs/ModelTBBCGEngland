...
params: 
  model: ""
  model_dir: "results/evaluated-scenarios-2019-03-26_22:30:59/log_non_uk-2019-03-28_15:37:16"
vignette: >
...
safe_plot_sensitivity(inc_sens)$result
```

- Calculate childhood incidence sensitivity to parameters at the maximum time fitted to.

```{r}
child_inc_sens <- safe_test_sensitivity(model, obs = "YearlyChildInc")$result
...
safe_plot_sensitivity(child_inc_sens)$result
```
...
plot_state(model, states = c("YearlyHistPInc", "YearlyInc", "YearChildInc", "YearlyOlderAdultInc"), summarise = FALSE, start_time = 49) -> p2
