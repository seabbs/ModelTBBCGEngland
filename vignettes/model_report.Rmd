...
plot_state(model, states = c("YearlyAgeInc"), start_time = 69) +
  theme(legend.position = "none")
```

```{r summary-overview-states-1990-age, fig.height = 16, fig.width = 16, cache = TRUE}
plot_state(model, states = c("YearlyAgeInc"), start_time = 59, summarise = TRUE) +
  theme(legend.position = "none")
```

```{r summary-overview-states-2000-age, fig.height = 16, fig.width = 16, cache = TRUE}
plot_state(model, states = c("YearlyAgeInc"), start_time = 69, summarise = TRUE) +
  theme(legend.position = "none")
```
