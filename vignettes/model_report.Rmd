...
params: 
  model: ""
  model_dir: "results/evaluated-scenarios-2019-07-30_14:56:15-calibration-run/transmission_plus_mixing-2019-07-30_14:56:17"
vignette: >
...
plot_state(model, summarise = TRUE, end_time = 73)
```

- Plot an overview of states zoomed into 1990 onwards

```{r overview-states-1990, fig.height = 16, fig.width = 16}
plot_state(model, summarise = TRUE, start_time = 59, end_time = 73)
```
