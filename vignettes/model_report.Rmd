...
if (!exists("model_dir")) {
  model_dir <- "results/evaluated-scenarios-2018-10-05_20:15:16-calibration-run/baseline-2018-10-05_20:15:17"
}
...
```{r}
model <- sample_obs(model, noutputs = 73)
```
...
```{r}
child_inc_sens <- test_sensitivity(model, obs = "YearlyChildInc")
...
plot_sensitivity(child_inc_sens) 
```
