...
if (!exists("model_dir")) {
  model_dir <- "results/model-run-2018-09-11_18:35:55"
}
...
plot_param(model, scales = "free", plot_type = "trace", burn_in = 4000) + theme(legend.position = "none") + lims(x = c(4000, 5000))
```
...
plot_state(model, states = c("YearlyHistPInc", "YearlyInc"), summarise = TRUE, start_time = 59) -> p2
