...
if (!exists("model_dir")) {
  model_dir <- "results/model-run-2018-09-13_12:45:09"
}
...
```{r}
baseline_scenario <- sample(model, target = "prediction",
...
plot_state(model, states = c("YearlyHistPInc", "YearlyInc"), start_time = 59)
```
