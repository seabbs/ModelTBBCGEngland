...
add_row(
  ...
  add_row(
    ...
    Distribution = "$\\mathcal{N}(1,2)$",
    Units = "-",
    Source = "Assumption",
    Type = "Assumption",
    Method = "The prior distribution is based on values that map the scale up from an approximately linear relationship to a binary switch half between 1953 and 2000. A normal distrbution around the default gradient of 1 has been used.",
    Setting = "England",
    Fitted = "Yes",
    URL = "-"
  )%>%
