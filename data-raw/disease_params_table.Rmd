...
add_row(
  ...
  add_row(
    ...
    Source = "Assumption",
    Type = "Assumption",
    Method = "The prior distribution is based on values that map the scale up from an approximately linear relationship to a binary switch half between 1953 and 2000. ",
    Setting = "England",
    Fitted = "Yes",
    URL = "-"
  )%>%
