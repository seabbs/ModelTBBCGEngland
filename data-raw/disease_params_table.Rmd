...
add_row(
  ...
  add_row(
    ...
    Distribution = "$\\nu^P_{(0-14,15-89)} = \\mathcal{G}(8.78e-1, 2.06e-1)^{-1}$, $\\mathcal{G}(1.10, 3e-1)^{-1}$, $\\nu^E_{(0-14, 15-89)} = \\mathcal{G}(6.86e-1, 4.46e-1)^{-1}$, $\\mathcal{G}(8.97e-1, 5.36e-1)^{-1}$",
    Units = "$years^{-1}$",
    Source = "ETS",
    Type = "Derived from data",
    ...
    Distribution = "$\\phi^{P, E}_{0-14,15-69,70-89} = \\mathcal{G}(9.86, 6.1e-1)^{-1}$, $\\mathcal{G}(7.8, 8.27e-1)^{-1}$, $\\mathcal{G}(8.52, 7.24e-1)^{-1}$",
    Units = "$years^{-1}$",
    Source = "ETS",
    Type = "Derived from data",
