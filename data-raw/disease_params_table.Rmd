...
add_row(
  ...
  add_row(
    ...
    add_row(
    Parameter = "$\\nu_{scale}$",
    Description = "Rate of treatment scale up. Time to treatment is assumed to scale using logit function from 1953 to 2000. This parameter controls the rate of this scale up.",
    Distribution = "1",
    Units = "-",
    Source = "Assumption",
    Type = "Assumption",
    ...
    Distribution = "$\\mu^{P, E}_{0-14,15-59,60-89} = \\mathcal{N}(3.9e-3, 1.8e-2)$, $\\mathcal{N}(2.26e-2, 7.87e-3)$, $\\mathcal{N}(1.17e-1, 1.65e-2)$ truncated to be greater than 0.",
    Units = "$years^{-1}$",
    Source = "ETS",
    Type = "Derived from data",
    ...
    Distribution = "$\\zeta^{P, E}_{0-14,15-59,60-89} = \\mathcal{N}(9.76e-3, 1.79e-2)$, $\\mathcal{N}(3.04e-2, 7.64e-3)$, $\\mathcal{N}(6.14e-3, 1.59e-2)$, truncated to be greater than 0.",
    Units = "$years^{-1}$",
    Source = "ETS",
    Type = "Derived from data",
