...
#' @param scales Character string, defaulting to "free". What scales to use for graph faceting.
#' @param prior_params A prior parameter set as generated by \code{fit_model}. Alternatively a `libbi` model can be passed.
