...
model Baseline {
  ...
  sub proposal_parameter {
    M ~ truncated_gaussian(mean = M, std = 0.01, lower = 0.5, upper = 1)                       
    c_eff ~ truncated_gaussian(mean = c_eff, std = 0.1, lower = 0, upper = 5)                  
    c_hist ~ truncated_gaussian(mean = c_hist, std = 0.1, lower = 10, upper = 15)               
    beta_child_mod ~ truncated_gaussian(mean = beta_child_mod, std = 0.2, lower = 0)          
    beta_older_adult_mod ~ truncated_gaussian(mean = beta_older_adult_mod, std = 0.2, lower = 0)
    delta ~ truncated_gaussian(mean = delta, std = 0.02, lower = 0, upper = 1)               
    epsilon_h_0_4 ~ truncated_gaussian(mean = epsilon_h_0_4, std = 0.2, lower = 0)             
    epsilon_h_5_14 ~ truncated_gaussian(mean = epsilon_h_5_14, std = 0.2, lower = 0)           
    epsilon_h_15_89 ~ truncated_gaussian(mean = epsilon_h_15_89, std = 0.2, lower = 0)          
    kappa_0_4 ~ truncated_gaussian(mean = kappa_0_4, std = 0.2, lower = 0)                      
    kappa_5_14 ~ truncated_gaussian(mean = kappa_5_14, std = 0.2, lower = 0)                   
    kappa_15_89 ~ truncated_gaussian(mean = kappa_15_89, std = 0.2, lower = 0)                 
    epsilon_l_0_4 ~ truncated_gaussian(mean = epsilon_l_0_4, std = 0.2, lower = 0)             
    epsilon_l_5_14 ~ truncated_gaussian(mean = epsilon_l_5_14, std = 0.2, lower = 0)            
    epsilon_l_15_89 ~ truncated_gaussian(mean = epsilon_l_15_89, std = 0.2, lower = 0)         
    phi_0_14 ~ truncated_gaussian(mean = phi_0_14, std = 0.2, lower = 0)                       
    phi_15_69 ~ truncated_gaussian(mean = phi_15_69, std = 0.2, lower = 0)                     
    phi_70_89 ~ truncated_gaussian(mean = phi_70_89, std = 0.2, lower = 0)                     
    Upsilon_0_14 ~ truncated_gaussian(mean = Upsilon_0_14, std = 0.02, lower = 0, upper = 1)   
    Upsilon_15_69 ~ truncated_gaussian(mean = Upsilon_15_69, std = 0.02, lower = 0, upper = 1) 
    Upsilon_70_89 ~ truncated_gaussian(mean = Upsilon_70_89, std = 0.02, lower = 0, upper = 1) 
    rho_0_14 ~ truncated_gaussian(mean = rho_0_14, std = 0.02, lower = 0, upper = 1)            
    rho_15_69 ~ truncated_gaussian(mean = rho_15_69, std = 0.02, lower = 0, upper = 1)         
    rho_70_89 ~ truncated_gaussian(mean = rho_70_89, std = 0.02, lower = 0, upper = 1)          
    nu_p_0_14 ~ truncated_gaussian(mean = nu_p_0_14, std = 0.2, lower = 0)                     
    nu_p_15_89 ~ truncated_gaussian(mean = nu_p_15_89, std = 0.2, lower = 0)                   
    nu_e_0_14 ~ truncated_gaussian(mean = nu_e_0_14, std = 0.2, lower = 0)                      
    nu_e_15_89 ~ truncated_gaussian(mean = nu_e_15_89, std = 0.2, lower = 0)                   
    zeta_0_14 ~ truncated_gaussian(mean = zeta_0_14, std = 0.2, lower = 0)                     
    zeta_15_69 ~ truncated_gaussian(mean = zeta_15_69, std = 0.2, lower = 0)                   
    zeta_70_89 ~ truncated_gaussian(mean = zeta_70_89, std = 0.2, lower = 0)                   
    mu_p_0_14 ~ truncated_gaussian(mean = mu_p_0_14, std = 0.2, lower = 0)                     
    mu_p_15_69 ~ truncated_gaussian(mean = mu_p_15_69, std = 0.2, lower = 0)                   
    mu_p_70_89 ~ truncated_gaussian(mean = mu_p_70_89, std = 0.2, lower = 0)                   
    mu_e_0_14 ~ truncated_gaussian(mean = mu_e_0_14, std = 0.2, lower = 0)                      
    mu_e_15_69 ~ truncated_gaussian(mean = mu_e_15_69, std = 0.2, lower = 0)                   
    mu_e_70_89 ~ truncated_gaussian(mean = mu_e_70_89, std = 0.2, lower = 0)                  
    chi_init ~ truncated_gaussian(mean = chi_init, std = 0.02, lower = 0, upper = 1)            
    alpha_t_init ~ gaussian(mean = alpha_t_init, std = 0.2)                                    
    alpha_t_decay ~ gaussian(mean = alpha_t_decay, std = 0.2)                                 
    HistMeasError ~ truncated_gaussian(mean = HistMeasError, std = 0.2, lower = 0) 
  }
}