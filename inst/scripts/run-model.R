...
model <- fit_model(model = "BaseLineModel", gen_data = FALSE, 
                   ...
                   fit = FALSE, posterior_samples = 100, sample_ess_at = 0.1,
                   rejuv_moves = 1, nthreads = 4, verbose = TRUE, libbi_verbose = TRUE, 
                   fitting_verbose = TRUE, pred_states = FALSE, spacing_of_historic_tb = 10,
                   const_pop = FALSE, no_age = FALSE, no_disease = FALSE, scale_rate_treat = TRUE, years_of_age = c(2000), 
                   ...
                   save_output = FALSE, dir_path = "./vignettes/results", dir_name = NULL, reports = TRUE, browse = TRUE)
