...
model <- fit_model(model = "BaseLineModel", gen_data = FALSE, 
                   ...
                   adapt_proposal = TRUE, adapt_prop_samples = 250, adapt_prop_it = 4, adapt = "both",
                   adapt_scale = 2, min_acc = 0.05, max_acc = 0.4,
                   fit = TRUE, posterior_samples = 4000, sample_ess_at = 0.2,
                   rejuv_moves = NULL, nthreads = 4, verbose = TRUE, libbi_verbose = TRUE, 
                   fitting_verbose = TRUE, pred_states = TRUE, browse = FALSE,
                   const_pop = FALSE, no_age = FALSE, no_disease = FALSE, scale_rate_treat = TRUE, years_of_age = c(2000, 2004), age_groups = 0,
                   noise = TRUE,
