...
model <- fit_model(model= "BaseLineModel", gen_data = FALSE, run_time = 73, plot_obs = TRUE,
                   ...
                   adapt_particles = TRUE, min_particles = 1, max_particles = 128, adapt_part_samples = 1000, adapt_part_it = 1, 
                   adapt_proposal = TRUE,  adapt_prop_samples = 2000, adapt_prop_it = 3,
                   adapt_scale = 4, adapt = "both",
                   fit = TRUE, posterior_samples = 5000, thin = 5, burn_prop = 0, 
