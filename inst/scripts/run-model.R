...
model <- fit_model(model = "BaseLineModel", gen_data = FALSE, 
                   ...
                   adapt_particles = TRUE, adapt_part_samples = 1000, adapt_part_it = 1, 
                   min_particles = NULL, max_particles = NULL,
                   proposal_param_block = NULL, proposal_initial_block = NULL, 
                   adapt_proposal = TRUE, adapt_prop_samples = 1000, adapt_prop_it = 3, adapt = "both",
                   adapt_scale = 2, min_acc = 0.2, max_acc = 0.4,
                   fit = TRUE, posterior_samples = 5000, thin = 1, burn_prop = 0, sample_ess_at = 0.2,
